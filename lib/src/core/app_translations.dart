const Map<String, Map<String, String>> appTranslations = {
  ...
  'ru': {
    ...
    'New closure or PON box': 'Новая муфта или PON бокс',
    'Cancel object creation': 'Отменить создание объекта',
    'Open in closure notebook': 'Открыть в блокноте муфт',
    ...
    'Type: {value}': 'Тип: {value}',
    'Task: {name}': 'Задача: {name}',
    'Area: {value}': 'Район: {value}',
    'area: {value}': 'район: {value}',
    'note: {value}': 'примечание: {value}',
    'Add cable': 'Добавить кабель',
    'No cables added': 'Кабели не добавлены',
    'Details': 'Подробнее',
    'Source route': 'Исходный маршрут',
    ...
    'No splitters added': 'Делители не добавлены',
    ...
    'Select a closure on the left': 'Выберите муфту слева',
    'There are no closures in the selected area yet.':
        'В выбранном районе пока нет муфт.',
    'Create a closure, select it in the list, then add cables, splitters, and connections in the detail pane.':
        'Создайте муфту, выберите её в списке, затем добавьте кабели, делители и соединения в панели деталей.',
    'Change': 'Изменить',
